...
move_uploaded_file($_FILES['image']['tmp_name'],$imagePath);
			$sql="INSERT INTO tproprietaire (noms,adresse,contact,mail,typepieceid,numeropieceid,image,username,password,usersession) VALUES('".$noms."','".$adresse."','".$contact."','".$mail."','".$typepieceid."','".$numeropieceid."','".$image."','".$username."','".$passwordhash."','".$usersession."')";
			$connect->query($sql);
