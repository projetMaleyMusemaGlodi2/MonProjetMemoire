...
move_uploaded_file($_FILES['image']['tmp_name'],$imagePath);
			$sql="UPDATE tclient set noms='".$noms."', adresse='".$adresse."', contact='".$contact."', mail='".$mail."', typepieceid='".$typepieceid."', numeropieceid='".$numeropieceid."', username='".$username."', usersession='".$usersession."',image='".$image."' WHERE id='".$id."'";
			$connect->query($sql);
