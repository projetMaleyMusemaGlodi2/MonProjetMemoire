...
class AideUser extends StatefulWidget {
  @override
  _AideUserState createState() => _AideUserState();
}

class _AideUserState extends State<AideUser> {
...
Future<List<AlertFull>> downloadJSON() async {
  final response = await http.post(PubCon.cheminPhp + "GetAide.php",body:{
  });
