...
class UpdateProfilChauffeur extends StatefulWidget {
  @override
  _UpdateProfilChauffeurState createState() => _UpdateProfilChauffeurState();
}

class _UpdateProfilChauffeurState extends State<UpdateProfilChauffeur> {
  @override
   void initState() { 
...
Future updateUpdateProfile(File imageFile, BuildContext ctx) async {
    try{
      //id,noms,adresse,contact,mail,typepieceid,numeropieceid,image,username,password,usersession,compte
        ...
        var uri = Uri.parse(PubCon.cheminPhp + "updateChauffeur.php");
