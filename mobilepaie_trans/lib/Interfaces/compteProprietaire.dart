...
class CompteProprietaire extends StatefulWidget {
  @override
  _CompteProprietaireState createState() => _CompteProprietaireState();
}

class _CompteProprietaireState extends State<CompteProprietaire> {
  @override
