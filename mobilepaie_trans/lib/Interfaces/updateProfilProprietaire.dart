...
class UpdateProfilProprietaire extends StatefulWidget {
  @override
  _UpdateProfilProprietaireState createState() => _UpdateProfilProprietaireState();
}

class _UpdateProfilProprietaireState extends State<UpdateProfilProprietaire> {
  @override
  void initState() { 
...
Future updateUpdateProfile(File imageFile, BuildContext ctx) async {
    try{
      //id,noms,adresse,contact,mail,typepieceid,numeropieceid,image,username,password,usersession,compte
        ...
        var uri = Uri.parse(PubCon.cheminPhp + "updateProprietaire.php");
